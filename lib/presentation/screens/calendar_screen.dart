...
class _CalendarScreenState extends ConsumerState<CalendarScreen> {
  ...
  Map<DateTime, Map<String, bool>> _monthlyPoints =
      {}; // Puntos para el mes completo
  ...
  Widget _buildEventList() {
    ...
    return Column(
      children: [
        ...
        Text(
            'Duración total de entrenamientos: ${totals['totalDuration']} mins'),
  ...
  Future<void> _deleteEvent(BuildContext context, Map<String, dynamic> event,
    ...
    try {
      ...
      if (event['type'] == 'calories') {
        ref
            ...
            .removeDailyCaloriesByCalories(event['_id']);
      }
      // Mostramos un mensaje de confirmación
      await _fetchDailyData(_focusedDay);
  ...
  void _showDeleteConfirmationDialog(BuildContext context,
      Map<String, dynamic> event, String collectionName, String documentId) {
    showDialog(
      context: context,
